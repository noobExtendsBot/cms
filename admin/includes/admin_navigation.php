        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="post_dropdown" class="collapse">
                    <li>
                        <a href="admin_post.php">View All Post</a>
                    </li>
                    <li>
                        <a href="admin_post.php?source=add_posts">Add Post</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <a href="javascript:;" data-toggle="collapse" data-target="#user_section"><i class="fa fa-fw fa-arrows-v"></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
